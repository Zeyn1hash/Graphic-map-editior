...
def new_map_loop():
    ...
    input_name=LineEdit(window.get_width()/2-120*10/2, 380, 120*10, 140,"AuX_DotBitC_Xtra.ttf", "Map name")
    ...
    while True:
        for e in event.get():
            ...
            if e.type == KEYDOWN:
                if e.key == K_1:
                    ...
                    return "menu"
                elif e.key == K_RETURN and start_enabled:
                    return "editor"
        ...
        window.blit(font.Font("AuX_DotBitC_Xtra.ttf", 50).render("Enter a name for the new map below", True, "black"), (60, 300))
